...
class MenuScene extends Phaser.Scene {
  ...
  // start("MenuScene",{highscore: this.highscore})
  init(data) {
  ...
  create() {
    ...
    // kap 8.1
    startButton.on('pointerdown', () => this.scene.start('GameScene', { highscore: this.highscore }))
    ...
    // kap 8.1
    highscoreButton.on('pointerdown', () => {
      this.scene.start('HighscoreScene', { highscore: this.highscore });
    });
