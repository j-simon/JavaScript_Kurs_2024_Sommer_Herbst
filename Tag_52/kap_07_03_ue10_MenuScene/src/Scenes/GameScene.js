...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.scoreText = this.add.text(16, 16, 'Score: ' + this.score, { fontSize: '32px' }).setScrollFactor(0); // Punktanzeige
        this.lifeText = this.add.text(1100, 16, 'Lives: ' + this.lives, { fontSize: '32px' }).setScrollFactor(0); // Lebensanzeige
    ...
    pauseGame() {
        ...
        this.gameOver = true; // Setzt das Spiel auf "game over"
