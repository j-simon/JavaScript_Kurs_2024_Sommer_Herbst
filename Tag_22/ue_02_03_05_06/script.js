...
// console.log(document.querySelectorAll('#product_specification  li.keyword'))
...
// // document.querySelector('h1.article span').innerHTML = "hallo Welt!"
// console.log(document.querySelectorAll('h1.article span'))
// document.querySelectorAll('h1.article span').innerHTML="hallo Welt"
...
console.log($$('ol.model[data-model*="V7"]'))
